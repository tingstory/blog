...
However，Just My Socks 月付 2.88 的番茄缺货中，预计年底才会补货（目前最低价 $5.88）。价格敏感的用户可以选 [flycloud](https://www.flycloud.us/auth/register?code=Lugd) 家的番茄，月付最低只要 ￥5（使用优惠码 `S11` 后只要 ￥4）。
